...
const DashboardSideBar = ({active}) => {
  return (
    ...
    {/* single item */}
        ...
        <div className="w-full flex items-center p-4">
            <Link to="/dashboard-trends" className='w-full flex items-center'>
                <MdOutlineLocalOffer size={30} color={`${active === 8 ? "crimson" : "#555"}`} />
                <h5 
        ...
        <div className="w-full flex items-center p-4">
            <Link to="/dashboard-create-trend" className='w-full flex items-center'>
                <VscNewFile size={30} color={`${active === 9 ? "crimson" : "#555"}`} />
                <h5 
        ...
        <div className="w-full flex items-center p-4">
            <Link to="/dashboard-coupons" className='w-full flex items-center'>
                <AiOutlineGift size={30} color={`${active === 12 ? "crimson" : "#555"}`} />
                <h5 
        ...
        <div className="w-full flex items-center p-4">
            <Link to="/dashboard-refunds" className='w-full flex items-center'>
                <HiOutlineReceiptRefund size={30} color={`${active === 13 ? "crimson" : "#555"}`} />
                <h5 
