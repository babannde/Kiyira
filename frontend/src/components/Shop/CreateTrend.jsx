...
import { createTrend } from '../../redux/actions/trend';
import {toast} from "react-toastify";

const CreateTrend = () => {
    const { seller } = useSelector((state) => state.seller);
    const { success,error } = useSelector((state) => state.trends);
    ...
    <div className='w-[90%] 800px:w-[50%] bg-white shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                placeholder='Enter trend price with discount...'
                />
            </div>
            <br />
            <div>
                ...
                placeholder='Enter Trend stock...'
                />
            </div>
            <br />
            <div>
                <label className='pb-2'>
                    Trend Start Date<span className='text-red-500'>*</span>
                </label>
                <input 
                type="date"
                name="startDate"
                ...
                min={today}
                placeholder='Enter Trend start date...'
                />
            </div>
            <br />
            <div>
                <label className='pb-2'>
                    Trend End Date<span className='text-red-500'>*</span>
                </label>
                <input 
                type="date"
                name="endDate"
                ...
                min={minEndDate}
                placeholder='Enter Trend end date...'
                />
            </div>
            <br />
            <div>
